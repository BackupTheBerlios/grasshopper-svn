...
# Just a hack to get linux kernel 2.6.15 running
ifeq ($(DEFAULT_KERNEL_HEADERS),2.6.15)
DOWNLOAD_LINUX26_VERSION=$(DEFAULT_KERNEL_HEADERS)
LINUX26_VERSION=$(DEFAULT_KERNEL_HEADERS)
else
